...
<div class="all"> 
    ...
    <div class="menu">
        <div class="pilihan">
            <div class="kotak_in">
	            <p class="tulisan_in">Yakin?</p>
	            <form action="" method="post">
		            <input type="hidden" name="nomor" value="<?= $tiket["nomor"]; ?>">
                    <input type="hidden" name="booked" value="<?= $tiket["booked"]; ?>">
                    <input type="hidden" name="status" value="Yes">
                    <input type="hidden" name="by" value="<?= $tiket["by"]; ?>">
		            <button type="submit" name="submit" class="in">IN</button>
	            </form>
	        </div>
        </div>
        <div class="bawah">
